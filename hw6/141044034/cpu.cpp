...
{
    myMemory.setMem(myMemory.getMemoryAdress(input2),getRegister(getRegisterAdress(input1)));
}
void CPU::mov4(Memory& myMemory)
{
    setRegister(getRegisterAdress(input2),myMemory.getMem(myMemory.getMemoryAdress(input1))) ;

}
void CPU::mov5(Memory& myMemory)
{
    myMemory.setMem( myMemory.getMemoryAdress(input1) , strToInt(input2)) ;
...
{
    setRegister(getRegisterAdress(input1),getRegister(getRegisterAdress(input1))+ myMemory.getMem(myMemory.getMemoryAdress(input2)));
}
...
{
	cout << myMemory.getMem(myMemory.getMemoryAdress(input1)) << endl;
}
