...
void CPU::jmp1() 
{
    if(getRegister(getRegisterAdress(input1)) == 0)
        setPC(strToInt(input2)-1);   //array starts from 0 but txt lines start from 1 (-1)and main program adds 1 to i for execute next instruction (-1).
